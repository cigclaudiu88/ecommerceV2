                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table daily-sale-report">
                            ...
                            <tbody>
                                <tr>
                                    <td class="fw-600">Alexander Payne</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="fw-600">Linda Price</td>
                                    <td>
                                        <p>Sed do eiusmod tempor incididunt ut labore.</p>
                                    </td>
                                ...
                                <tr>
                                    <td class="fw-600">Patrick Newman</td>
                                    <td>
                                        <p>Sed do eiusmod tempor incididunt ut labore.</p>
                                    </td>
                                ...
                                <tr>
                                    <td class="fw-600">Jose Brewer</td>
                                    <td>
                                        <p>Sed do eiusmod tempor incididunt ut labore.</p>
                                    </td>
                                ...
                                <tr>
                                    <td class="fw-600">Amber Price</td>
                                    <td>
                                        <p>Sed do eiusmod tempor incididunt ut labore.</p>
                                    </td>
                ...
                <div class="box-body">
                        ...
                        <ul class="widget-chat-list">
                            <li>
                                <div class="widget-chat">
                                    ...
                                    <div class="body">
                                        <div class="image"><img
                                                src="{{ asset('backend/images/comment/comment-1.jpg') }}" alt="">
                                        </div>
                                        <div class="content">
                            ...
                            <li>
                                <div class="widget-chat">
                                    ...
                                    <div class="body">
                                        <div class="image"><img
                                                src="{{ asset('backend/images/comment/comment-2.jpg') }}" alt="">
                                        </div>
                                        <div class="content">
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                            ...
                            <li>
                                <div class="widget-chat">
                                    ...
                                    <div class="body">
                                        <div class="image"><img
                                                src="{{ asset('backend/images/comment/comment-3.jpg') }}" alt="">
                                        </div>
                                        <div class="content">
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                industry.</p>
                    ...
                    <div class="widget-chat-submission">
                        <form action="#">
                            ...
                            <div class="buttons">
                                <label class="file-upload button button-sm button-box button-round button-primary"
                                    for="chat-file-upload">
                                    <input type="file" id="chat-file-upload" multiple>
                                    <i class="zmdi zmdi-attachment-alt"></i>
                                </label>
                                <button class="submit button button-sm button-box button-round button-primary"><i
                    ...
                    <div class="news-update-inner">
                        ...
                        <div class="news-item">
                            ...
                            <div class="content">
                                ...
                                <!-- Title -->
                                <h4 class="title"><a href="#">Sed do eiusmod tempor incididunt ut
                                        labore. Lorem Ipsum is simplydummy text of the printing and typesetting
                                        industry.</a></h4>
                                <!-- Meta -->
                                <ul class="meta">
                        ...
                        <div class="news-item">
                            ...
                            <div class="content">
                                ...
                                <!-- Title -->
                                <h4 class="title"><a href="#">Sed do eiusmod tempor labore. Lorem
                                        Ipsum is simplydummy text of the printing and.</a></h4>
                                <!-- Meta -->
                                <ul class="meta">
                                    <li><i class="zmdi zmdi-time"></i>10 Houre ago</li>
                        ...
                        <div class="news-item">
                            ...
                            <div class="content">
                                ...
                                <!-- Title -->
                                <h4 class="title"><a href="#">Sed do eiusmod typesetting industry.
                                        Lorem Ipsum is simplydummy text of the printing and typesetting
                                        industry.</a></h4>
                                <!-- Meta -->
                                <ul class="meta">
                                    <li><i class="zmdi zmdi-time"></i>10 Houre ago</li>
