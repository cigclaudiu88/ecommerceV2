...
@section('admin')
    <div class="row">
        ...
        <div class="col-12 mb-30">
            <div class="box">
                <div class="box-head">
                    <h3 class="title">Lista Comenzi in Asteptare <span class="badge badge badge-danger">
                                    ...
                                    <td width="30%">
                                        ...
                                        <a href="{{ route('pending.order.details', $item->id) }}"
                                            class="button button-primary"><i
                                                class="fa-solid fa-magnifying-glass"></i><strong>Vizualizare</strong></a>
                                        ...
                                        @if ($item->status == 'In asteptare')
                                            <a href="{{ route('delivered.canceled', $item->id) }}"
                                                class="button button-danger" id="cancel_order"><strong>Anuleaza
                                                </strong></a>
                                        @endif
                                    </td>
                                </tr>
