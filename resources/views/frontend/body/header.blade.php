            ...
            <div class="col-12">
                ...
                <div class="offcanvas_menu_wrapper">
                    ...
                    <div class="logo">
                        ...
                        <a href="{{ url('/') }}"><img src="{{ asset($setting->logo) }}" alt=""
                                style="margin-bottom: 10px !important;"></a>
                    </div>
                    @php
                    ...
                    <div id="menu" class="text-left ">
                        <ul class="offcanvas_main_menu">
                            ...
                            @else
                                <li class="menu-item-has-children active">
                                    <a href="#">Autentificare / Inregistrare</a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ route('login') }}">Autentificare</a>
                                        </li>
                                        <li><a href="{{ route('register') }}">Inregistrare Cont</a>
                                        </li>
                                    </ul>
                                @endauth
                        </ul>
                                        ...
                                        <form method="post" action="{{ route('product.search') }}">
                                            ...
                                            <div class="search_box">
                                                <input placeholder="Cauta produse..." type="text" name="search"
                                                    id="search" onfocus="search_result_show()"
                                                ...
                                                <li>
                                                    <div class="header_account_list  mini_cart_wrapper">
                                                        ...
                                                        <a href="javascript:void(0)"><span
                                                                class="lnr lnr-cart"></span><span class="item_count"
                                                                id="cartQty"></span></a>
                                                        <!--mini cart-->
                                                        <div class="mini_cart">
